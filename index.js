...
//mongodb+srv://Nam123:<password>@cluster0.9dtea.mongodb.net/<dbname>?retryWrites=true&w=majority
mongoose.connect('mongodb+srv://Nam123:123@cluster0.9dtea.mongodb.net/demo?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }, function(err) {
    if (err) {
...
app.get("/Vape", controllerUser.weapon);
app.get("/Juice", controllerUser.char);
